...
const Contact = () => {
  return (
    <>
            ...
            >
              ...
              <div className="mt-10 bg-gray-100 p-4 rounded-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Follow us on social media to stay updated with our latest news and product releases.
                </p>
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-600 hover:text-brown-900 transition-colors">
      ...
      {/* Google Map or Location Embed could go here */}
      <div className="h-96 bg-gray-200 w-full">
        <div className="h-full flex items-center justify-center text-gray-500">
          <p>Map Placeholder - Interactive Map Would Be Embedded Here</p>
        </div>
      </div>
    </>
  );
